...
public class buyProductTestCase {
	...
	public void testMain() {
		...
		add.checkoutSummary();
		newUser.newAccount("pier@testedb.com");
		String addressAccount = "Rua Itajubá, 810";
		String cityAccount = "Curitiba";
		newUser.personalInformation("Jean Pierre", "Gonzalez", "password", addressAccount, cityAccount, "01234", "1584106902");
